...
const STEPS = [
  ...
  },
  {
    ...
    title: 'Filter by Expat Suitability.',
    body: 'The score (1–5) tells you how practical a destination is for expat life — visa ease, safety, community. Higher is easier.',
    cta: 'Next →',
    position: 'right',
    requiresInteraction: true,
  ...
  },
  {
    ...
    body: '↑ Improving destinations are ones where conditions for expats are actively getting better. Worth filtering for if you\'re planning long-term.',
    cta: 'Next →',
    position: 'right',
    requiresInteraction: true,
  ...
  },
  {
    ...
    body: 'Pick the advantages you care about — strong expat community, low cost, great weather, fast internet. Only places that match will show.',
    cta: 'Next →',
    position: 'right',
    requiresInteraction: true,
